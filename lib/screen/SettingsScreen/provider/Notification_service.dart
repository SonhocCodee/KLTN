...
class NotificationService {
  ...
  Future<bool> isAllEnabled() async =>
      (await _prefs()).getBool(_keyAllNotif) ?? true;
  Future<bool> isDailyEnabled() async =>
      (await _prefs()).getBool(_keyDailyNotif) ?? true;
  Future<bool> isStreakEnabled() async =>
      (await _prefs()).getBool(_keyStreakNotif) ?? true;
  ...
  Future<void> scheduleDailyAnimalNotifications() async {
    ...
    final messages = [
      (
        id: _dailyAnimalMorningId,
        hour: 8,
        title: '🌅 Buổi sáng cùng thế giới động vật!',
        body: 'Hôm nay bạn đã khám phá loài vật mới chưa? Vào xem ngay!',
      ),
      (
        id: _dailyAnimalAfternoonId,
        hour: 13,
        title: '🌞 Giờ nghỉ trưa, khám phá động vật nào!',
        body: 'Một loài vật thú vị đang chờ bạn khám phá hôm nay!',
      ),
      (
        id: _dailyAnimalEveningId,
        hour: 19,
        title: '🌙 Buổi tối, đừng bỏ lỡ!',
        body: 'Bạn vẫn chưa xem động vật của ngày hôm nay. Còn kịp đấy!',
      ),
    ];
  ...
  Future<void> scheduleStreakNotifications() async {
    ...
    final messages = [
      (
        id: _streakMorningId,
        hour: 9,
        title: '🔥 Chuỗi của bạn đang chờ!',
        body: 'Đừng để chuỗi bị phá vỡ! Vào làm nhiệm vụ ngay nhé.',
      ),
      (
        id: _streakAfternoonId,
        hour: 14,
        title: '⚡ Streak vẫn còn đó, nhanh vào thôi!',
        body: 'Bạn đang làm rất tốt! Duy trì chuỗi thêm một ngày nữa.',
      ),
      (
        id: _streakEveningId,
        hour: 20,
        title: '⏰ Còn ít thời gian giữ Streak!',
        body: 'Đêm nay bạn đừng quên vào hoàn thành nhiệm vụ nhé!',
      ),
    ];
  ...
  // tính thời điểm tiếp theo cho giờ:phút
  ...
  // hoặc dùng background fetch để kiểm tra trước khi gửi)
