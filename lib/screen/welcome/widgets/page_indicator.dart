    ...
    return Row(
      ...
      children: List.generate(pageCount, (index) {
        ...
        return GestureDetector(
          onTap: () =>
              onDotTap(index), // Khi bấm, gọi hàm onDotTap và gửi số thứ tự đi
          // AnimatedContainer: Giống Container thường nhưng tự động làm mượt khi thay đổi kích thước/màu sắc
          child: AnimatedContainer(
            duration: const Duration(
              milliseconds: 400,
            ), // Thời gian chạy hiệu ứng (0.4 giây)
            curve: Curves
                .easeInOutCubic, // Kiểu chuyển động (nhanh dần rồi chậm lại cho tự nhiên)
                  ...
                  ? [
                      BoxShadow(
                        color: gradientColors[0].withOpacity(
                          0.5,
                        ), // Bóng mờ theo màu chính
                        blurRadius: 8, // Độ nhòe của bóng
                        offset: const Offset(
                          0,
                          2,
                        ), // Bóng đổ xuống dưới một chút
                      ),
                    ]
