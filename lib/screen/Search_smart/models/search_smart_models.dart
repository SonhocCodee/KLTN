...
final List<AnimalTypeConfig> allAnimalTypes = [
  ...
  _makeWildConfig(
    key: 'fish', animalType: 'fish', emoji: '🐟', nameVi: 'Cá', nameEn: 'Fish',
    questions: const [
      QuestionConfig(id: 'primary_habitat', question: 'Cá sống ở môi trường nào?', emoji: '🌊', column: 'primary_habitat',
        options: [
      ...
      QuestionConfig(id: 'diet_type', question: 'Kiểu ăn của cá?', emoji: '🍽️', column: 'diet_type',
        options: [
          ...
          OptionConfig(label: 'Ăn sinh vật phù du', emoji: '🫧', value: 'planktivore'),
        ],
      ),
      QuestionConfig(id: 'relative_size', question: 'Kích thước cá?', emoji: '📏', column: 'relative_size',
        options: [
      ...
      QuestionConfig(id: 'conservation_status', question: 'Tình trạng bảo tồn?', emoji: '🛡️', column: 'conservation_status',
        options: [
          OptionConfig(label: 'Ít quan tâm', emoji: '✅', value: 'Least Concern'),
          OptionConfig(label: 'Sắp bị đe dọa', emoji: '⚠️', value: 'Near Threatened'),
          OptionConfig(label: 'Dễ tổn thương', emoji: '🟠', value: 'Vulnerable'),
  ...
  _makeWildConfig(
    key: 'bird', animalType: 'bird', emoji: '🐦', nameVi: 'Chim', nameEn: 'Bird',
    questions: const [
      QuestionConfig(id: 'primary_habitat', question: 'Chim sống chủ yếu ở đâu?', emoji: '🌍', column: 'primary_habitat',
        options: [
          OptionConfig(label: 'Rừng', emoji: '🌲', value: 'forest'),
          OptionConfig(label: 'Đất liền', emoji: '🌾', value: 'terrestrial'),
          OptionConfig(label: 'Nước ngọt / đầm lầy', emoji: '🦆', value: 'freshwater'),
          OptionConfig(label: 'Biển / ven biển', emoji: '🌊', value: 'ocean'),
          OptionConfig(label: 'Sa mạc', emoji: '🏜️', value: 'desert'),
        ],
      ),
      QuestionConfig(id: 'diet_type', question: 'Chim ăn gì là chính?', emoji: '🍽️', column: 'diet_type',
        options: [
          OptionConfig(label: 'Ăn côn trùng', emoji: '🐛', value: 'insectivore'),
      ...
      QuestionConfig(id: 'locomotion', question: 'Cách di chuyển nổi bật?', emoji: '🪽', column: 'locomotion',
        options: [
      ...
      QuestionConfig(id: 'activity_pattern', question: 'Hoạt động vào lúc nào?', emoji: '⏰', column: 'activity_pattern',
        options: [
