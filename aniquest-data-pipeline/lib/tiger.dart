...
class AnimalConfig {
  static const String ANIMAL_TYPE = 'tiger';
  static const String TRAITS_TABLE = 'tiger_traits';
  static const String ANIMAL_NAME_VI = 'Hổ';
  static const String ANIMAL_NAME_EN = 'Tiger';
  ...
  static const String WIKI_KEYWORD = 'tiger';
}
...
3. stripe_pattern: classic, sparse, dense, white_tiger
4. hunting_strategy: ambush, stalking, pursuit
5. hunting_time: nocturnal, crepuscular, diurnal
...

{
  "animal": {
    "animal_type": "tiger",
    "name_vietnamese": "Hổ [Vietnamese translation]",
    ...
    "primary_habitat": "tropical_forest",
    ...
    "height_avg_m": 1.0,
    "length_avg_m": 2.8,
    "primary_colors": ["orange","black","white"],
    "patterns": ["striped"],
    "fur_type": "short_fur",
    "max_speed_kmh": 65,
  ...
  "tiger_traits": {
    "stripe_pattern": "classic",
    "has_white_variant": false,
    "swimming_ability": 4,
    "climbing_ability": 3,
    "hunting_strategy": "ambush",
    "territory_size_km2": 100.0,
    "solitary_level": 5,
    "hunting_time": "nocturnal",
    "subspecies": "Bengal/Siberian/etc",
    "habitat_preference": "tropical_forest",
    "typical_sounds": ["roar","chuff","growl","snarl"]
  }
}
